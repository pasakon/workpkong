...
public class Platformm extends Pane {
    ...
    public void render(Snake snake, Food food) {
        ...
        snake.getBody().forEach(p -> { gc.fillRect(p.getX() * TILE_SIZE, p.getY() * TILE_SIZE, TILE_SIZE, TILE_SIZE); });
        ...
        gc.fillRect(food.getspecailPosition().getX() * TILE_SIZE, food.getspecailPosition().getY() * TILE_SIZE, TILE_SIZE, TILE_SIZE);
    }
